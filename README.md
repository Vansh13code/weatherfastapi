Weather Data Analytics API (FastAPI)📌 Overview
...
📌 API Endpoints📥 1. Upload DatasetPOST /api/upload
...
🌍 2. Weather CRUD Operations🔹 Get All Records
GET /api/weather
...
🌐 3. External API IntegrationPOST /api/weather/fetch/{city}
Fetches real-time weather data and appends it to dataset.
Example:
/api/weather/fetch/Delhi
📊 4. Data Analysis APIs🔹 Average Temperature Per City
...
📈 5. Data Visualization APIs🔹 Temperature Trend
